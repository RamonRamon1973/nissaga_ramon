...
async function loadData(){
  ...
  // Llista incrustada directament (abans es carregava de data/direct_line.json,
  // però la incrustem aquí perquè no depengui de cap subcarpeta)
  directLine = ["I501521","I325","I328","I501532","I501541","I500357","I500355","I500352","I500350","I43","I41","I39","I37","I35","I500007","I500003","I500001"];
...
function renderRiver(){
  ...
  directLine.forEach((pid, i) => {
    ...
    dot.className = "dot";
    if (p.photo_file) {
      dot.style.backgroundImage = `url(${p.photo_file})`;
      dot.textContent = "";
    } else {
...
function openPerson(id){
  ...
  const photoHtml = p.photo_file
    ? `<img class="modal-photo" src="${p.photo_file}" alt="${p.full_name}">`
